...
const ActivityRelQuerent = QuerentFactory.getRelQuerent(RealmSchema.ActivityRelationship, ARQuerent);
const CategoryRelQuerent = QuerentFactory.getRelQuerent(RealmSchema.CategoryRelationship, CRQuerent);
const SeqCategoryRelQuerent = QuerentFactory.getRelQuerent(RealmSchema.SequentialCategoryRelationship, CRQuerent);
