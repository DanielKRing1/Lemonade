...
export class TrendBlueprint {
  ...
  public static TREND_BLUEPRINT_SCHEMA_DEF: Realm.ObjectSchema = {
  ...
  public static TREND_BLUEPRINT_SCHEMA_BLUEPRINT: SchemaBlueprint = new SchemaBlueprint(BlueprintNameEnum.Trend, DEFAULT_PATH, SchemaTypeEnum.Blueprint, TrendBlueprint.SCHEMA_BLUEPRINT_SCHEMA_DEF);
